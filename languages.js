...
export const languages = {
  en: {
    ...
    niche_suggestion_intro: "🤖 **AI Niche Suggestion**\n\nI'll help you find the perfect business niche for lead generation!\n\nI'll ask you a few questions about your goals and preferences, then suggest the best niches based on your answers.\n\n💡 **This will help you discover high-potential opportunities you might not have considered.**\n\n🚀 **Ready to start?**\n\n1️⃣ **YES, START QUESTIONS** - Begin AI niche suggestion\n0️⃣ **BACK** - Return to niche input\n0️⃣0️⃣ **RESTART** - Return to main menu",
    niche_suggestion_invalid_choice: "⚠️ **Invalid input.** Please choose a number between 1 and {max_choices}.",
    niche_suggestion_invalid_text: "⚠️ **Invalid input.** Please provide a meaningful answer (at least 2 characters).",
    niche_suggestion_processing: "🤖 **AI is analyzing your answers...**\n\nPlease wait while I generate personalized niche suggestions based on your responses...",
    niche_suggestion_error: "❌ **Error generating suggestions**\n\nSorry, I couldn't generate niche suggestions at the moment.\n\n💡 **You can still:**\n• Enter your own niche manually\n• Try again later\n• Contact support if the issue persists\n\n0️⃣ **BACK** - Return to niche input\n0️⃣0️⃣ **RESTART** - Return to main menu",
    niche_suggestion_selected: "✅ **Niche Selected!**\n\nYou've chosen: **{niche}**\n\n🎯 **Proceeding with this niche for lead generation...**",
    niche_suggestion_custom: "✅ **Custom Niche Accepted!**\n\nYou've entered: **{niche}**\n\n🎯 **Proceeding with your custom niche for lead generation...**",
  ...
  fr: {
    ...
    // Niche Suggestion Flow
    niche_suggestion_intro: "🤖 **Suggestion de Niche IA**\n\nJe vais vous aider à trouver la niche commerciale parfaite pour la génération de prospects!\n\nJe vais vous poser quelques questions sur vos objectifs et préférences, puis suggérer les meilleures niches basées sur vos réponses.\n\n💡 **Cela vous aidera à découvrir des opportunités à fort potentiel que vous n'auriez peut-être pas considérées.**\n\n🚀 **Prêt à commencer?**\n\n1️⃣ **OUI, COMMENCER LES QUESTIONS** - Démarrer la suggestion de niche IA\n0️⃣ **RETOUR** - Retour à la saisie de niche\n0️⃣0️⃣ **REDÉMARRER** - Retour au menu principal",
    niche_suggestion_invalid_choice: "⚠️ **Entrée invalide.** Veuillez choisir un nombre entre 1 et {max_choices}.",
    niche_suggestion_invalid_text: "⚠️ **Entrée invalide.** Veuillez fournir une réponse significative (au moins 2 caractères).",
    niche_suggestion_processing: "🤖 **L'IA analyse vos réponses...**\n\nVeuillez patienter pendant que je génère des suggestions de niches personnalisées basées sur vos réponses...",
    niche_suggestion_error: "❌ **Erreur lors de la génération des suggestions**\n\nDésolé, je n'ai pas pu générer de suggestions de niches pour le moment.\n\n💡 **Vous pouvez toujours :**\n• Entrer votre propre niche manuellement\n• Réessayer plus tard\n• Contacter le support si le problème persiste\n\n0️⃣ **RETOUR** - Retour à la saisie de niche\n0️⃣0️⃣ **REDÉMARRER** - Retour au menu principal",
    niche_suggestion_selected: "✅ **Niche Sélectionnée!**\n\nVous avez choisi : **{niche}**\n\n🎯 **Procédant avec cette niche pour la génération de prospects...**",
    niche_suggestion_custom: "✅ **Niche Personnalisée Acceptée!**\n\nVous avez entré : **{niche}**\n\n🎯 **Procédant avec votre niche personnalisée pour la génération de prospects...**",
    
    // Source Selection
    select_source: "🎯 **Quel type de résultats voulez-vous pour \"{niche}\"?**\n\n1️⃣ **Contacts** – Emails 📧 & Numéros de Téléphone 📱\n2️⃣ **Profils** – Noms, URLs LinkedIn & Infos Professionnelles 👤\n3️⃣ **Entreprises** – Noms, Téléphones, Emails, Localisation & Site Web 🏢\n4️⃣ **🤖 IA Recommande** – Laissez l'IA choisir la meilleure option\n\n0️⃣ **Retour** – Retour à la saisie d'entreprise/service\n0️⃣0️⃣ **Redémarrer** – Commencer une nouvelle recherche\n\n💬 **Répondez avec le numéro** correspondant à votre choix.",
    
    // AI Decision Messages
    ai_analyzing: "🤖 **L'IA analyse votre demande...**\n\nAnalyse de : \"{niche}\"\n\nVeuillez patienter pendant que je détermine la meilleure source de données pour vos besoins...",
    ai_recommendation: "🤖 **Recommandation IA**\n\nPour \"{niche}\", je recommande :\n\n**{recommended_source}** - {reason}\n\n✅ **Procédant avec la recommandation IA...**",
    
    // Data Type Selection
    select_type_google: "📋 **Sélectionnez le Type de Données pour Contacts d'Entreprise:**\n\n1️⃣ **EMAILS** - Extraire uniquement les adresses email\n2️⃣ **PHONES** - Extraire uniquement les numéros de téléphone\n3️⃣ **CONTACTS** - Emails et téléphones\n\n0️⃣ **RETOUR** - Retour à la sélection de source\n0️⃣0️⃣ **REDÉMARRER** - Commencer une nouvelle recherche\n\n💬 **Répondez avec le numéro** correspondant à votre choix.",
    select_type_linkedin: "📋 **Sélectionnez le Type de Données pour Profils Professionnels:**\n\n1️⃣ **PROFILES** - Profils professionnels uniquement\n2️⃣ **CONTACTS** - Informations de contact (emails/téléphones)\n3️⃣ **COMPLETE** - Données de profil complètes\n\n0️⃣ **RETOUR** - Retour à la sélection de source\n0️⃣0️⃣ **REDÉMARRER** - Commencer une nouvelle recherche\n\n💬 **Répondez avec le numéro** correspondant à votre choix.",
    select_type_maps: "📋 **Sélectionnez le Type de Données pour Entreprises Locales:**\n\n1️⃣ **PROFILES** - Profils d'entreprises avec adresses\n2️⃣ **CONTACTS** - Informations de contact (emails/téléphones)\n3️⃣ **COMPLETE** - Données d'entreprise complètes\n\n0️⃣ **RETOUR** - Retour à la sélection de source\n0️⃣0️⃣ **REDÉMARRER** - Commencer une nouvelle recherche\n\n💬 **Répondez avec le numéro** correspondant à votre choix.",
    select_type_all: "📋 **Sélectionnez le Type de Données pour Toutes les Sources de Données:**\n\n1️⃣ **CONTACTS** - Informations de contact de toutes les sources\n2️⃣ **COMPLETE** - Données complètes de toutes les sources\n\n0️⃣ **RETOUR** - Retour à la sélection de source\n0️⃣0️⃣ **REDÉMARRER** - Commencer une nouvelle recherche\n\n💬 **Répondez avec le numéro** correspondant à votre choix.",
  ...
  ar: {
    ...
    // Niche Validation Messages
    niche_validating: "🔍 **التحقق من إدخالك...**\n\nالتحليل: \"{niche}\"\n\nيرجى الانتظار أثناء التحقق من إدخالك...",
    niche_validation_error: "❌ **إدخالك غير صالح**\n\n**السبب:** {reason}\n\n**💡 جرب هذه الأمثلة بدلاً من ذلك:**\n{suggestions}\n\n**📝 كيفية كتابة شركة أو خدمة جيدة:**\n• أضف نوع عمل (طبيب أسنان، محامي، مطور، إلخ)\n• أضف موقع (مدينة، منطقة أو بلد)\n• كن محدداً وواضحاً\n\n**مثال:** \"طبيب أسنان الدار البيضاء\" أو \"مطور ويب فاس\"\n\n0️⃣ **العودة إلى القائمة** - العودة إلى القائمة الرئيسية",
    
    // Niche Suggestion Flow
    niche_suggestion_intro: "🤖 **اقتراح تخصص بالذكاء الاصطناعي**\n\nسأساعدك في العثور على التخصص التجاري المثالي لتوليد العملاء المحتملين!\n\nسأطرح عليك بعض الأسئلة حول أهدافك وتفضيلاتك، ثم أقترح أفضل التخصصات بناءً على إجاباتك.\n\n💡 **هذا سيساعدك في اكتشاف فرص عالية الإمكانات قد لا تكون قد فكرت فيها.**\n\n🚀 **هل أنت مستعد للبدء؟**\n\n1️⃣ **نعم، ابدأ الأسئلة** - بدء اقتراح التخصص بالذكاء الاصطناعي\n0️⃣ **رجوع** - العودة لإدخال التخصص\n0️⃣0️⃣ **إعادة تشغيل** - العودة إلى القائمة الرئيسية",
    niche_suggestion_invalid_choice: "⚠️ **إدخال غير صحيح.** يرجى اختيار رقم بين 1 و {max_choices}.",
    niche_suggestion_invalid_text: "⚠️ **إدخال غير صحيح.** يرجى تقديم إجابة ذات معنى (على الأقل حرفين).",
    niche_suggestion_processing: "🤖 **الذكاء الاصطناعي يحلل إجاباتك...**\n\nيرجى الانتظار بينما أقوم بتوليد اقتراحات تخصصات مخصصة بناءً على استجاباتك...",
    niche_suggestion_error: "❌ **خطأ في توليد الاقتراحات**\n\nعذراً، لم أتمكن من توليد اقتراحات التخصصات في الوقت الحالي.\n\n💡 **يمكنك دائماً:**\n• إدخال تخصصك الخاص يدوياً\n• المحاولة مرة أخرى لاحقاً\n• الاتصال بالدعم إذا استمرت المشكلة\n\n0️⃣ **رجوع** - العودة لإدخال التخصص\n0️⃣0️⃣ **إعادة تشغيل** - العودة إلى القائمة الرئيسية",
    niche_suggestion_selected: "✅ **تم اختيار التخصص!**\n\nلقد اخترت: **{niche}**\n\n🎯 **المتابعة مع هذا التخصص لتوليد العملاء المحتملين...**",
    niche_suggestion_custom: "✅ **تم قبول التخصص المخصص!**\n\nلقد أدخلت: **{niche}**\n\n🎯 **المتابعة مع تخصصك المخصص لتوليد العملاء المحتملين...**",
    
    // Source Selection
    select_source: "🎯 **ما نوع النتائج التي تريدها لـ \"{niche}\"؟**\n\n1️⃣ **جهات الاتصال** – الإيميلات 📧 & أرقام الهواتف 📱\n2️⃣ **الملفات الشخصية** – الأسماء، روابط LinkedIn & معلومات الوظيفة 👤\n3️⃣ **الشركات** – الأسماء، الهواتف، الإيميلات، الموقع & الموقع الإلكتروني 🏢\n4️⃣ **🤖 توصية الذكاء الاصطناعي ** – دع الذكاء الاصطناعي يختار أفضل خيار\n\n0️⃣ **رجوع** – العودة لإدخال الشركة/الخدمة\n0️⃣0️⃣ **إعادة تشغيل** - بدء بحث جديد\n\n💬 **أرسل الرقم** المقابل لاختيارك.",
    
    // AI Decision Messages
    ai_analyzing: "🤖 **الذكاء الاصطناعي يحلل طلبك...**\n\nتحليل: \"{niche}\"\n\nيرجى الانتظار بينما أحدد أفضل مصدر بيانات لاحتياجاتك...",
    ai_recommendation: "🤖 **توصية الذكاء الاصطناعي**\n\nلـ \"{niche}\"، أنصح بـ:\n\n**{recommended_source}** - {reason}\n\n✅ **المتابعة مع توصية الذكاء الاصطناعي...**",
    
    // Data Type Selection
    select_type_google: "📋 **اختر نوع البيانات لجهات اتصال الأعمال:**\n\n1️⃣ **EMAILS** - استخراج عناوين البريد الإلكتروني فقط\n2️⃣ **PHONES** - استخراج أرقام الهاتف فقط\n3️⃣ **CONTACTS** - البريد الإلكتروني والهاتف معاً\n\n0️⃣ **رجوع** - العودة لاختيار المصدر\n0️⃣0️⃣ **إعادة تشغيل** - بدء بحث جديد\n\n💬 **أرسل الرقم** المقابل لاختيارك.",
    select_type_linkedin: "📋 **اختر نوع البيانات للملفات الشخصية المهنية:**\n\n1️⃣ **PROFILES** - الملفات الشخصية المهنية فقط\n2️⃣ **CONTACTS** - معلومات الاتصال (بريد إلكتروني/هاتف)\n3️⃣ **COMPLETE** - بيانات الملف الشخصي الكاملة\n\n0️⃣ **رجوع** - العودة لاختيار المصدر\n0️⃣0️⃣ **إعادة تشغيل** - بدء بحث جديد\n\n💬 **أرسل الرقم** المقابل لاختيارك.",
    select_type_maps: "📋 **اختر نوع البيانات للشركات المحلية:**\n\n1️⃣ **PROFILES** - ملفات الأعمال مع العناوين\n2️⃣ **CONTACTS** - معلومات الاتصال (بريد إلكتروني/هاتف)\n3️⃣ **COMPLETE** - بيانات الأعمال الكاملة\n\n0️⃣ **رجوع** - العودة لاختيار المصدر\n0️⃣0️⃣ **إعادة تشغيل** - بدء بحث جديد\n\n💬 **أرسل الرقم** المقابل لاختيارك.",
    select_type_all: "📋 **اختر نوع البيانات لجميع مصادر البيانات:**\n\n1️⃣ **CONTACTS** - معلومات الاتصال من جميع المصادر\n2️⃣ **COMPLETE** - البيانات الكاملة من جميع المصادر\n\n0️⃣ **رجوع** - العودة لاختيار المصدر\n0️⃣0️⃣ **إعادة تشغيل** - بدء بحث جديد\n\n💬 **أرسل الرقم** المقابل لاختيارك.",
